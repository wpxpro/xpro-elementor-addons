	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .xpro-infolist-layout-horizontal .xpro-infolist-item' => 'width:calc(100%/var(--xpro-grid-item) - {{SIZE}}{{UNIT}}); margin-left: calc({{SIZE}}{{UNIT}}/2); margin-right: calc({{SIZE}}{{UNIT}}/2);',
				),
				'condition'  => array(
					'layout' => 'horizontal',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .xpro-infolist-layout-vertical .xpro-infolist-item:not(:nth-last-child(1))' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .xpro-infolist-layout-horizontal .xpro-infolist-item'                       => 'margin-bottom: {{SIZE}}{{UNIT}};',
