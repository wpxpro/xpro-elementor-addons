...
class Woo_Add_To_Cart extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'show_stock',
			array(
				'label'        => esc_html__( 'Show Stock Status', 'xpro' ),
				'description'  => esc_html__( 'Show stock status, If product have stock enable.', 'xpro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'xpro' ),
				'label_off'    => esc_html__( 'No', 'xpro' ),
				'default'      => 'yes',
				'return_value' => 'yes',
				'selectors'    => array(
		...
		$this->add_control(
			...
			array(
				'label'        => esc_html__( 'Variation Description', 'xpro' ),
				'description'  => esc_html__( 'Show product variation description.', 'xpro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'xpro' ),
				'label_off'    => esc_html__( 'No', 'xpro' ),
				'default'      => 'yes',
		...
		$this->add_responsive_control(
			...
			array(
				'label'     => esc_html__( 'Alignment', 'xpro' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => array(
					'left'   => array(
						'title' => esc_html__( 'Left', 'xpro' ),
						'icon'  => 'eicon-text-align-left',
					),
					'center' => array(
						'title' => esc_html__( 'Center', 'xpro' ),
						'icon'  => 'eicon-text-align-center',
					),
					'right'  => array(
						'title' => esc_html__( 'Right', 'xpro' ),
						'icon'  => 'eicon-text-align-right',
					),
				),
				'selectors' => array(
					'{{WRAPPER}} .stock' => 'text-align: {{VALUE}}',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'          => esc_html__( 'Typography', 'xpro' ),
				...
				'fields_options' => array(
					...
					'font_size'      => array(
						'label'      => esc_html__( 'Font Size (px)', 'xpro' ),
						'default'    => array(
							'size' => '14',
							'unit' => 'px',
						),
					...
					'line_height'    => array(
						'label'      => esc_html__( 'Line Height (px)', 'xpro' ),
						'default'    => array(
							'size' => '17',
							'unit' => 'px',
						),
		...
		$this->add_control(
			'in_stock_color',
			array(
				'label'     => esc_html__( 'In Stock Color', 'xpro' ),
		...
		$this->add_control(
			'out_of_stock_color',
			array(
				'label'     => esc_html__( 'Out Of Stock Color', 'xpro' ),
				'type'      => Controls_Manager::COLOR,
				'alpha'     => false,
				'selectors' => array(
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Quantity Input', 'xpro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			'quantity_bg_color',
			array(
				'label'     => esc_html__( 'Background Color', 'xpro' ),
				'type'      => Controls_Manager::COLOR,
				'alpha'     => false,
				'selectors' => array(
		...
		$this->add_group_control(
			...
			array(
				...
				'label'          => esc_html__( 'Border', 'xpro' ),
				'size_units'     => array( 'px' ),
				'fields_options' => array(
					'border' => array(
						'selectors' => array(
							'{{WRAPPER}} .quantity .qty' => 'border-style: {{VALUE}};',
							'{{WRAPPER}} .xpro-quantity-wrap button' => 'border-style: {{VALUE}};',
						),
					),
					'width'  => array(
						'selectors' => array(
							'{{WRAPPER}} .xpro-quantity-wrap .quantity .qty'     => 'border-width: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
							'{{WRAPPER}} .xpro-quantity-wrap .xpro-minus'             => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
							'{{WRAPPER}} .xpro-quantity-wrap .xpro-plus'              => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						),
					),
					'color'  => array(
						'alpha'     => false,
						'selectors' => array(
							...
							'{{WRAPPER}} .xpro-quantity-wrap button' => 'border-color: {{VALUE}};',
						),
					),
				),
			)
		...
		$this->add_control(
			...
			array(
				'label'      => esc_html__( 'Border Radius', 'xpro' ),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Increment', 'xpro' ),
		...
		$this->add_control(
			...
			array(
				'label'      => esc_html__( 'Icon Size', 'xpro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			'quantity_btn_padding',
			array(
				'label'      => esc_html__( 'Padding', 'xpro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px' ),
				'selectors'  => array(
					'{{WRAPPER}} .xpro-quantity-wrap .xpro-plus,{{WRAPPER}} .xpro-quantity-wrap .xpro-minus' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->start_controls_section(
			'variations_styles',
			array(
				'label' => esc_html__( 'Variations', 'xpro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Display Style', 'xpro' ),
				'type'      => Controls_Manager::CHOOSE,
				'default'   => 'row',
				'options'   => array(
					'row'    => array(
		...
		$this->add_control(
			...
			array(
				'label'      => esc_html__( 'Label Width', 'xpro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range'      => array(
					'px' => array(
		...
		$this->start_controls_tab(
			...
			array(
				'label'     => esc_html__( 'Description', 'xpro' ),
				'condition' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Price Color', 'xpro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Sale Price Color', 'xpro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Discount Badge Color', 'xpro' ),
				'type'      => Controls_Manager::COLOR,
				'alpha'     => false,
				'default'   => '#FFFFFF',
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Discount Badge Background', 'xpro' ),
				'type'      => Controls_Manager::COLOR,
				'alpha'     => false,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'      => esc_html__( 'Badge Font Size', 'xpro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			'variation_dropdown',
			array(
				'label'     => esc_html__( 'Dropdown', 'xpro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Dropdown Color', 'xpro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .variations select' => 'color: {{VALUE}};',
				),
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Space Between', 'xpro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px' ),
				'selectors'  => array(
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Swatches', 'xpro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'      => esc_html__( 'Swatch Width', 'xpro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			...
			array(
				'label'      => esc_html__( 'Swatch Height', 'xpro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Selected Border', 'xpro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Text Color', 'xpro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
