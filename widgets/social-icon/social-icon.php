	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} .xpro-social-icon > i,
                     {{WRAPPER}} {{CURRENT_ITEM}} .xpro-social-icon .xpro-social-icon-title' => 'color: {{VALUE}};',
				),
				'condition' => array(
					'social_inline_style' => 'yes',
				),
		...
		$repeater->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} .xpro-social-icon ' => 'background-color: {{VALUE}};',
				),
				'condition' => array(
					'social_inline_style' => 'yes',
				),
		...
		$repeater->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} .xpro-social-icon ' => 'border-color: {{VALUE}};',
				),
				'condition' => array(
					'social_inline_style' => 'yes',
				),
		...
		$repeater->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} .xpro-social-icon:hover > i,
                     {{WRAPPER}} {{CURRENT_ITEM}} .xpro-social-icon:hover .xpro-social-icon-title ' => 'color: {{VALUE}};',
				),
				'condition' => array(
					'social_inline_style' => 'yes',
				),
		...
		$repeater->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} .xpro-social-icon:hover ' => 'background-color: {{VALUE}};',
				),
				'condition' => array(
					'social_inline_style' => 'yes',
				),
		...
		$repeater->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} .xpro-social-icon:hover ' => 'border-color: {{VALUE}};',
				),
				'condition' => array(
					'social_inline_style' => 'yes',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .xpro-social-icon > i' => 'height: {{SIZE}}{{UNIT}}; width: {{SIZE}}{{UNIT}};',
