...
class Woo_Product_Grid extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'qv_tax_link_bg_color',
			array(
				'label'     => __( 'Link Background Color', 'xpro-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-qv-main-wrapper .product_meta .posted_in a' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Seprator Color', 'xpro-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_responsive_control(
			'qv_seprator_size',
			array(
				'label'      => __( 'Seprator Size', 'xpro-elementor-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', 'vh', '%' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-qv-main-wrapper .quantity .minus, {{WRAPPER}}  .xpro-qv-main-wrapper .quantity .plus' => 'color: {{VALUE}} !important;',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-qv-main-wrapper .quantity .minus, {{WRAPPER}}  .xpro-qv-main-wrapper .quantity .plus' => 'background-color: {{VALUE}} !important;',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'       => __( 'Border', 'xpro-elementor-addons' ),
				'placeholder' => '1px',
				'selector'    => '{{WRAPPER}} .xpro-qv-main-wrapper .quantity .minus, {{WRAPPER}}  .xpro-qv-main-wrapper .quantity .plus',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .xpro-qv-main-wrapper .quantity .minus, {{WRAPPER}}  .xpro-qv-main-wrapper .quantity .plus, {{WRAPPER}}  .xpro-qv-main-wrapper .quantity input.qty' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->start_controls_section(
			'variations_styles',
			array(
				'label' => esc_html__( 'Popup Variations', 'xpro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Popup Swatches', 'xpro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
