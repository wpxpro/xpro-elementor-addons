	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} .xpro-table-head-column-cell-text' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_responsive_control(
			'head_align',
			array(
				'label'     => __( 'Alignment', 'elementor-elementor-addons' ),
				'type'      => Controls_Manager::CHOOSE,
				'separator' => 'before',
				'options'   => array(
					'left'   => array(
						'title' => __( 'Left', 'elementor-elementor-addons' ),
						'icon'  => 'fa fa-align-left',
					),
					'center' => array(
						'title' => __( 'Center', 'elementor-elementor-addons' ),
						'icon'  => 'fa fa-align-center',
					),
					'right'  => array(
						'title' => __( 'Right', 'elementor-elementor-addons' ),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'type'      => Controls_Manager::SLIDER,
				'selectors' => array(
					'{{WRAPPER}} .xpro-table-body-row-cell:first-child' => 'border-top-left-radius: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .xpro-table-body-row-cell:last-child'  => 'border-top-right-radius: {{SIZE}}{{UNIT}};',
				),
			)
		);
