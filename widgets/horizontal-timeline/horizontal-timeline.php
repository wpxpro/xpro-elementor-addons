...
class Horizontal_Timeline extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label'     => __( 'Navigation', 'xpro-elementor-addons' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'nav' => 'yes',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .xpro-horizontal-timeline-prev' => 'left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .xpro-horizontal-timeline-next' => 'right: {{SIZE}}{{UNIT}};',
				),
				'condition'  => array(
					'nav_offset_toggle' => 'yes',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .xpro-horizontal-timeline-prev,
					{{WRAPPER}} .xpro-horizontal-timeline-next' => 'top: {{SIZE}}{{UNIT}};',
				),
				'condition'  => array(
					'nav_offset_toggle' => 'yes',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .xpro-horizontal-timeline-prev,
					 {{WRAPPER}} .xpro-horizontal-timeline-next' => 'font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .xpro-horizontal-timeline-prev,
					 {{WRAPPER}} .xpro-horizontal-timeline-next' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-horizontal-timeline-prev > i,
					{{WRAPPER}} .xpro-horizontal-timeline-next > i' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .xpro-horizontal-timeline-prev,
					{{WRAPPER}} .xpro-horizontal-timeline-next' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-horizontal-timeline-prev:hover > i,
					{{WRAPPER}} .xpro-horizontal-timeline-next:hover > i' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-horizontal-timeline-prev:hover,
					 {{WRAPPER}} .xpro-horizontal-timeline-next:hover' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .xpro-horizontal-timeline-prev:hover,
					{{WRAPPER}} .xpro-horizontal-timeline-next:hover' => 'border-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'nav_border',
				'label'    => __( 'Border', 'xpro-elementor-addons' ),
				'selector' => '{{WRAPPER}} .xpro-horizontal-timeline-prev,{{WRAPPER}} .xpro-horizontal-timeline-next',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .xpro-horizontal-timeline-prev, 
					{{WRAPPER}} .xpro-horizontal-timeline-next' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .xpro-horizontal-timeline-inner .owl-carousel .owl-dots' => 'text-align: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .xpro-horizontal-timeline-inner .owl-carousel .owl-dot'        => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .xpro-horizontal-timeline-inner .owl-carousel .owl-dot.active' => 'width: calc({{SIZE}}{{UNIT}} * 2);',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-horizontal-timeline-inner .owl-carousel .owl-dot' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-horizontal-timeline-inner .owl-carousel .owl-dot.active' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .xpro-horizontal-timeline-inner .owl-carousel .owl-dot.active' => 'border-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'dots_border',
				'label'    => __( 'Border', 'xpro-elementor-addons' ),
				'selector' => '{{WRAPPER}} .xpro-horizontal-timeline-inner .owl-carousel .owl-dot',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .xpro-horizontal-timeline-inner .owl-carousel .owl-dot' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .xpro-horizontal-timeline-inner .owl-carousel .owl-dot' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
