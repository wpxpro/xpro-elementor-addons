	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'label'   => __( 'Content Source', 'xpro-elementor-addons' ),
				'default' => 'editor',
				'options' => array(
		...
		$this->add_responsive_control(
			'space_between',
			array(
				'label'      => __( 'Space Between', 'xpro-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_responsive_control(
			'width',
			array(
				'label'      => __( 'Width', 'xpro-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_responsive_control(
			'height',
			array(
				'label'      => __( 'Height', 'xpro-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __( 'Typography', 'xpro-addons-pro' ),
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __( 'Background', 'xpro-addons-pro' ),
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __( 'Box Shadow', 'xpro-addons-pro' ),
				'selector' => '{{WRAPPER}} .xpro-toggle-content-wrapper',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => __( 'Border', 'xpro-addons-pro' ),
				'selector' => '{{WRAPPER}} .xpro-toggle-content-wrapper',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => __( 'Border Radius', 'xpro-addons-pro' ),
		...
		$this->add_responsive_control(
			'tab_content_padding',
			array(
				'label'      => __( 'Padding', 'xpro-addons-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
		...
		$this->add_responsive_control(
			'tab_content_margin',
			array(
				'label'      => __( 'Margin', 'xpro-addons-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
