	...
	protected function register_controls() {
		...
		$repeater->add_responsive_control(
			...
			array(
				...
				'default'   => '1',
				'selectors' => array(
					'{{WRAPPER}} {{CURRENT_ITEM}}.xpro-contact-form-item' => 'max-width: calc(100% / {{VALUE}});',
				),
			)
		);
		...
		$this->add_control(
			'success_message',
			array(
				'label'              => __( 'Success Message', 'xpro-elementor-addons' ),
				'type'               => Controls_Manager::TEXT,
		...
		$this->add_control(
			'error_message',
			array(
				'label'              => __( 'Error Message', 'xpro-elementor-addons' ),
				'type'               => Controls_Manager::TEXT,
		...
		$this->add_control(
			...
			array(
				'label'              => __( 'Required Message', 'xpro-elementor-addons' ),
				'type'               => Controls_Manager::TEXT,
		...
		$this->add_control(
			'captcha_message',
			array(
				'label'              => __( 'reCaptcha Message', 'xpro-elementor-addons' ),
				'type'               => Controls_Manager::TEXT,
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .xpro-contact-form-item > label' => 'padding-bottom: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->start_controls_section(
			'message_style',
			array(
				'label' => __( 'Message', 'xpro-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .xpro-contact-form-message' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'default'   => '1',
				'selectors' => array(
					'{{WRAPPER}} .xpro-contact-form-item-type-submit' => 'max-width: calc(100% / {{VALUE}});',
				),
			)
		);
