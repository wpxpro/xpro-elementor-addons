...
class Swatches {
	...
	public function init() {
		...
		$this->set_attribute_types( self::PA_COLOR, esc_html__( 'Xpro Color', 'xpro' ) );
		$this->set_attribute_types( self::PA_IMAGE, esc_html__( 'Xpro Image', 'xpro' ) );
		$this->set_attribute_types( self::PA_LABEL, esc_html__( 'Xpro Label', 'xpro' ) );
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				'i18n'  => array(
					'title'  => esc_html__( 'Choose an image', 'xpro' ),
					'button' => esc_html__( 'Use image', 'xpro' ),
				),
