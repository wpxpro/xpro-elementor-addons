...
class Xpro_Elementor_Custom_CSS {
	...
	public function __construct() {
		...
		add_action( 'elementor/element/after_section_end', array( $this, 'xpro_elementor_add_section_custom_css_controls' ), 25, 3 );
	...
	public function xpro_elementor_add_section_custom_css_controls( $element, $section_id ) {

		if ( 'section_custom_css_pro' !== $section_id ) {
			return;
		}

		if ( ! defined( 'ELEMENTOR_PRO_VERSION' ) && in_array( $element->get_name(), array( 'section', 'column', 'common' ), true ) ) {
