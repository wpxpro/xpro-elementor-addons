			...
			<div class="xpro-row">
				...
				<div class="xpro-col-lg-4">
					<div class="xpro-dashboard-text-form-wrapper pro <?php echo esc_attr( $this->utils->is_widget_active_class( 'google-map', $pro_active ) ); ?>">
						<h4 class="xpro-dashboard-text-form-title">
							<?php esc_html_e( 'Google Map', 'xpro-elementor-addons' ); ?>
						</h4>
						<hr class="xpro-dashboard-text-form-seperator">
						<p class="xpro-dashboard-text-form-description">
						...
						$this->utils->input(
							array(
								...
								'label'       => esc_html__( 'Google Map API', 'xpro-elementor-addons' ),
								'placeholder' => esc_html__( 'Enter Google Map API Here', 'xpro-elementor-addons' ),
				...
				<div class="xpro-col-lg-4">
					<div class="xpro-dashboard-text-form-wrapper pro <?php echo esc_attr( $this->utils->is_widget_active_class( 'street-map', $pro_active ) ); ?>">
						<h4 class="xpro-dashboard-text-form-title">
							<?php esc_html_e( 'Street Map', 'xpro-elementor-addons' ); ?>
						</h4>
						<hr class="xpro-dashboard-text-form-seperator">
						<p class="xpro-dashboard-text-form-description">
				...
				<!--Twitter-->
				<div class="xpro-col-lg-4">
					<div class="xpro-dashboard-text-form-wrapper pro <?php echo esc_attr( $this->utils->is_widget_active_class( 'twitter-feed', $pro_active ) ); ?>">
						<h4 class="xpro-dashboard-text-form-title">
							<?php esc_html_e( 'Twitter Access', 'xpro-elementor-addons' ); ?>
						</h4>
						<hr class="xpro-dashboard-text-form-seperator">
						<p class="xpro-dashboard-text-form-description">
							Go to <a href="https://developer.twitter.com/en" target="_blank">https://developer.twitter.com/en</a> for create your Consumer key and Access Token.
						</p>
						<?php
						$this->utils->input(
							array(
								'type'        => 'text',
								'name'        => 'xpro_elementor_user_data[twitter][user_name]',
								'label'       => esc_html__( 'User Name', 'xpro-elementor-addons' ),
								'placeholder' => __( 'Enter Username Here', 'xpro-elementor-addons' ),
								'value'       => ( ! isset( $xpro_elementor_user_data['twitter']['user_name'] ) ) ? '' : ( $xpro_elementor_user_data['twitter']['user_name'] ),
							)
						);
						$this->utils->input(
							array(
								'type'        => 'text',
								'name'        => 'xpro_elementor_user_data[twitter][access_token]',
								'label'       => esc_html__( 'Secret Token', 'xpro-elementor-addons' ),
								'placeholder' => __( 'Enter Secret Key Here', 'xpro-elementor-addons' ),
								'value'       => ( ! isset( $xpro_elementor_user_data['twitter']['access_token'] ) ) ? '' : ( $xpro_elementor_user_data['twitter']['access_token'] ),
							)
						);
						?>
					</div>
					...
					<div class="xpro-dashboard-text-form-wrapper pro <?php echo esc_attr( $this->utils->is_widget_active_class( 'facebook-feed', $pro_active ) ); ?>">
						...
						$this->utils->input(
							array(
								...
								'placeholder' => __( 'Enter App ID Here', 'xpro-elementor-addons' ),
						...
						$this->utils->input(
							array(
								'type'        => 'text',
								'name'        => 'xpro_elementor_user_data[facebook][secret_key]',
								'label'       => esc_html__( 'Secret Key', 'xpro-elementor-addons' ),
								'placeholder' => __( 'Enter Secret Key Here', 'xpro-elementor-addons' ),
								'value'       => ( ! isset( $xpro_elementor_user_data['facebook']['secret_key'] ) ) ? '' : ( $xpro_elementor_user_data['facebook']['secret_key'] ),
							)
						);
						?>
					</div>
				...
				<div class="xpro-col-lg-12">
					<div class="xpro-dashboard-text-form-wrapper">
						...
						<p class="xpro-dashboard-text-form-description">
							...
							Invisible) and Copy and Paste here.
						</p>
						<?php
						$this->utils->input(
							array(
