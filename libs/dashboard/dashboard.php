...
class Xpro_Elementor_Dashboard {
	...
	public function register_settings_menus() {
		...
		// Add sub menu
		add_submenu_page( Xpro_Elementor_Addons::PAGE_SLUG, esc_html__( 'General', 'xpro-elementor-addons-pro' ), esc_html__( 'General', 'xpro-elementor-addons-pro' ), 'manage_options', Xpro_Elementor_Addons::PAGE_SLUG );
